...
async function fetchImageUrls() {
    try {
        const response = await fetch('https://new.shelterluv.com/api/v3/available-animals/13458?saved_query=1874&embedded=1&iframeId=shelterluv_wrap_1757291549&columns=1'); // Replace with your API endpoint
        if (!response.ok) {
